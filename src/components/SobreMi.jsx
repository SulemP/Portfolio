        ...
        <div className="sobremi-container">
            ...
            <div className="sobremi-column">
                ...
                <div className="sobremi-right">
                    ...
                    <div>
                        <p>
                            ¡Hola! Soy <span className="highlight-text">Sulem Pastrana</span>, apasionada de la creación web con 27 años de edad. Me encanta sumergirme en el mundo del desarrollo digital y actualmente me especializo en el front-end utilizando <span className="highlight-text">React.js</span>.
                            Sin embargo, mi sed de conocimiento me impulsa a ampliar mis
                            habilidades tanto en el front-end como en el back-end.
                        </p>

                        <p>
                            Soy egresada de la carrera de <span className="highlight-text">Ingeniería en Informática en UPIICSA</span>, donde adquirí una sólida base en los fundamentos de la informática y
                            el desarrollo de software. Actualmente, me encuentro inmersa en un <span className="highlight-text">curso de inglés</span> para mejorar mis habilidades lingüísticas y estoy comprometida en obtener mi título universitario, trabajando diligentemente en los procesos necesarios para lograrlo.
                        </p>
                        ...
                        more && (
                            <div className="showMore">
                                <div className="experiencia">
                                    <img src={Line}></img>
                                    <h2 className="texto">Mi experiencia profesional</h2>
                                    <img src={Line}></img>
                                </div>
                                
                                <div>
                                    <h4 className="highlight-text">INEIN Infraestructura e Interiores:</h4>
                                ...
                                <div>
                                    <h4 className="highlight-text">DIVUM Clínica cosmética de rostro y dientes:</h4>
                                ...
                                <div>
                                    <h4 className="highlight-text">Prácticas Profesionales BUSCALAB:</h4>
