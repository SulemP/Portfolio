...
const miData = {
    labels: ["D", "DF", "DB", "DR", "DA"], 
    datasets: [
        {
            label: 'Nivel de Experiencia',
            data: [3, 4, 1, 3, 4, 5], // niveles de experiencia correspondientes a cada período de tiempo
            fill: true,
            borderColor: '#C778DD',
            tension: 0.5,
            pointRadius: 5,
        ...
        <div id="acerca-de" className={Style.sobremiContainer}>
            ...
            <div className={Style.sobremi}>
                ...
                <div className={Style.sobremiLeft}>
                    <img className={Style.ipn} src={IPNImage} alt="IPN"></img>
                </div>
            ...
            <div className={Style.sobremiExperiencia}>
